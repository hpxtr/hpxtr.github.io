...
function render() {
  ...
  if (gameover) {
    ...
    const hn = declOfNum(scores.harry, [' Harry', ' Harry', ' Harry']);
    const tn = declOfNum(scores.tom, [' Tommy', ' Tommy', ' Tommy']);
    drawCenterText("Wow, you collected " + scores.harry + hn + " и ", level.x, level.y + 187, levelwidth);
