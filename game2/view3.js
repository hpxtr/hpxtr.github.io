...
function drawHeader() {
    ...
    var sgn66 = document.getElementById("sign");
...
function render() {
    ...
    if (gameover) {
        ...
        const hn = declOfNum(scores.harry, [' гаррик', ' гаррика', ' гарриков']);
        const tn = declOfNum(scores.tom, [' томик', ' томика', ' томиков']);
        drawCenterText("Воу, вы собрали " + scores.harry + hn + " и ", level.x, level.y + 187, levelwidth);
        drawCenterText(scores.tom + tn + "!", level.x, level.y + 212, levelwidth);
    }
}
